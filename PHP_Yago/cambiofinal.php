...
$euro = isset($_GET["euro"]) ? $_GET["euro"] : 1;
/// -----------------------------------------
...
?>
        <form action="cambiofinal.php" method="get">
        		<input type="number" name="euro" value="<?php echo $euro?>"required><br>
...
echo "Tiene un cambio respecto al euro de :".$mi_cambio[$moneda] * $euro."<br>";
} 
?>
        <hr>
    </body>
